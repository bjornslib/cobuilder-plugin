...
def render_assessment(title: str, assessment: dict, intent: dict | None) -> str:
    ...
    footer = "_Generated by cobuilder-architect submit mode"
...
def main() -> None:
    ...
    parser.add_argument("--bundle-dir", default=None, help="bundle dir (default: <repo>/.cobuilder-architect/self)")
    ...
    for pr_num in pr_nums:
        ...
        if not intent and not assessment:
            print(
                ...
                f"remediation: run /cobuilder-architect:submit --prs {pr_num} first.",
                file=sys.stderr,
            )
            exit_code = 1
            continue
