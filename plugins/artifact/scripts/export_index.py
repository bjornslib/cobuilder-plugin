...
on every `/artifact:publish` invocation. Its own small template, not a
...
from _bundle_meta import read_plugin_version, require_compatible, stamp_generator  # noqa: E402
