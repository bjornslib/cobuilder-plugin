 ...
 *
 * THIS FILE IS THE PORTED PROTOTYPE at `src/variations/sections-e/TopBar.tsx`, with one
 * import changed: `Theme` now comes from `./DiagramTiles`, because the port folds the
 * prototype's `Diagram.tsx` into that file.
 */
