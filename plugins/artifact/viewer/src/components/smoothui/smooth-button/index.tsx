...
// Repointed from the registry item's `@radix-ui/react-slot`. This application
// depends on the unified `radix-ui` package, which already exports `Slot`, so
// the split package would be a second copy of the same code. The unified export
// is a namespace object, hence `Slot.Root` at the one use site below.
