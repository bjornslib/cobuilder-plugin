...
upstream_path: clean-code/claude/.claude/rules/clean-code.md
...
This file defines mandatory working rules for Claude in this project. Follow these instructions before making any code, test, refactor, review, or documentation change.
