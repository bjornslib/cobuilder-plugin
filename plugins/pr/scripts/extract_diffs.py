...
from _bundle_meta import read_plugin_version, require_compatible, stamp_generator
...
TRUNCATION_MARKER = "\n… [truncated by pr: diff exceeds 4000 lines]"
BYTE_TRUNCATION_MARKER = "\n… [truncated by pr: diff exceeds 200KB on very few lines]"
GENERATED_EXPORT_NOTE = "[not diffed by pr: this is a previously-published bundle export, not source — its content is a base64-heavy self-contained HTML file, and diffing it against itself on every regenerate would balloon future diffs without adding anything narratively useful]"
